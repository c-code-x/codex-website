...
const Eventspage =()=>{
  return(
    <div className={styles.events_page}>
        <NavBar/>
            <div className={styles.ev_curosel}><Carousel className={styles.carousel_events}  autoPlay infiniteLoop showIndicators={false} showArrows={false} showStatus={false}  interval={3000}>
