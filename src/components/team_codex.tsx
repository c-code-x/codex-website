...
const data=[{
    ...
    name:"D Punith",
    role:"President",
    description:"The ONE responsible and accountable for executive leadership and operational direction of CODEX ",
    ...
    description:"Manages all the Logistical requirements and Clerical work along with coordinating and optimizing the movement of goods and resources that's necessary",
    ...
    description:"Craft compelling stories and Be the voice of our CODEX and build meaningful connections.",
    ...
    description:"The one responsible for leading and to create visually stunning and technically precise art assets that help in marketing and promotional aspect of CODEX ",
    ...
    name:"Hilux",
    role:"Front End - Lead",
    description:"Incharge of creating intuitive and visually stunning user experiences that immerse the user into the project",
    ...
    name:"Tushar",
    role:"Back End - Lead",
    description:"Lead the development of scalable, robust, and secure systems as our Back End Lead and shape the future of our technology.",
    insta:"#",
    ...
    description:"Lead the charge in crafting unforgettable gaming experiences that captivates your mind , as our Game Development Lead.",
    insta:"#",
    github:"#",
    linkdin:"#"
},{
    ...
    description:"Lead and manage the competitive programming team, providing strategic guidance and solutions to achieve success in coding challenges and competitions",
