...
const data=[{
    ...
    description:"Founder of CODEX. Established Codex and responsible of ensuring the smooth flow of events ",
    ...
    description:"Founder of CODEX.Tech enthusiast, Public speaker, Mentor to Current team , Motivator etc",
    ...
    description:"Established and Contributed to Competitive Programming domain in CODEX , initiated CODEX's trade mark event Coding contest/Hackathon",
    ...
    description:"Made CODEX a well known club by marketing all its events and publicizing it throughout GITAM",
    ...
    name:"Sujana",
    role:"Agent",
    description:"Hey Sujana Here! I was an agent at codex and the experience was really great. Being a part of the Organizing team during the hackathon i have learnt a lot.",
    ...
    name:"Navya sree",
    role:"Web devoloper",
    description:"The First Web Dev lead of CODEX , brought Web Devleopment domain and cultivated its intrest among Gitamites",
    ...
    name:"Madhulika",
    role:"Front End - Lead",
    description:"Developed websites for hackathons and helped design posters and banners for events.",
    ...
    name:"Nishita",
    role:"Content Writer",
    description:"Supported CODEX by being the Incharge of documentation and the content creatives in the club.",
