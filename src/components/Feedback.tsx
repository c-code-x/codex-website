            ...
            <div className={styles.feedback_inputs_box}>
                ...
                <form className={styles.feedback_inputs_box_form} onSubmit={handleSubmit}>
                    ...
                    <div className={styles.feedback_inputs_box_input1}>
                        ...
                        <input className={styles.feedback_inputs_box_name} id={"name"} placeholder={"your name"} onChange = {(e)=>setName(e.target.value)} type={"text"}></input>
                    </div>
                    <div className={styles.input2}>
                        <label className={styles.emaillabel} htmlFor={"email"} placeholder={"CODEX"}>Email</label>
                        <input className={styles.feedback_inputs_box_email} placeholder={"your mail-id"} onChange = {(e)=>setEmail(e.target.value)} id={"email"} type={"email"}></input>
                    </div>
                    </div>
                    ...
                    <div className={styles.input3}>
                        ...
                        <input className={styles.feedback_inputs_box_branch} placeholder={"Ex : CSE, Banglore(Campus)"} onChange = {(e)=>setBranch(e.target.value)}  id={"Branch"} type={"text"}></input>
                    </div>
                    <div className={styles.input4}>
                        <label className={styles.phnolabel} htmlFor={"phno"}>Phone Number</label>
                        <input className={styles.feedback_inputs_box_phno} id={"phno"} placeholder={"+91 00000 00000"} onChange = {(e)=>setPhno(e.target.value)} type={"tel"}></input>
                    </div>
                    </div>
                    ...
                    <div className={styles.withpng}>
                        <div className={styles.input5}>
                            ...
                            <textarea className={styles.feedback_inputs_box_query} name="query" placeholder={"Your feedback message..."} rows={4} cols={40} onChange = {(e)=>setMessage(e.target.value)} id={"query"}></textarea>
                        </div>
                        <button className={styles.feedback_submitbtn}><Image alt={""} src={send}/></button>
                    </div>
                    </div>
                </form>
            </div>
