...
export default function Footer(){
   ...
   <div className="content">
     ...
     <div className="middle box">
       ...
       <div><Link href="/LandingPage">Home</Link></div>
       <div><Link href="/UnderConstruction">About</Link></div>
         <div><Link href="/UnderConstruction">Domains</Link></div>
       <div><Link href="/UnderConstruction">Members</Link></div>
       <div><Link href="/UnderConstruction">Resources</Link></div>
     </div>
     <div className="middle box">
        <div className="topic">Services</div>
        <div><a href="/UnderConstruction">Resources</a></div>
        <div><a href="/UnderConstruction">Practice typing</a></div>
    </div>
     <div className="lower">
     ...
     <div className="right box">
       <div className="topic">Follow us</div>
         <div className="media-icons">
           <a href="https://discord.gg/QaytX8tA"><Image src={disc} alt=""/></a>
           <a href="https://github.com/c-code-x"><Image src={git} alt=""/></a>
           <a href="https://www.instagram.com/codex_gitam/"><Image src={insta} alt=""/></a>
           <a href="https://www.youtube.com/@codexgitam3817"><Image src={utube} alt=""/></a>
         </div>
     </div>
   </div>
   <div className="footr">
