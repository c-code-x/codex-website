...
import CAT from "../assets/posters/THOR_LOVE_2.jpg";
import cpro from "../assets/posters/c-programming.jpg";
import codify from "../assets/posters/web_design_.jpg";
import snap from "../assets/snapimg.png";
import Events from "@/components/Events";
import data from "../assets/jsonFIles/eventsgridcontent.json";
import Link from "next/link";
import lights from "../assets/Lights.png";
import side1 from "../assets/Untitled-8 1.png";
import side2 from "../assets/Untitled-8 2.png";
            ...
            <div className={styles.aboutus}>
                <div className={styles.flexbox1}>
                    ...
                    <p className={styles.abtcontent}>
                        ...
                        operates, keeping the needs of the student community in mind. What`&apos;`s
                        more, it never rests, ensuring you always have another event to attend,
                        another skill to develop, and another way to have a great time! There are
                        two sides to all engineering people. On one day, we may want to spend all
                        night coding, and on another, we may get the urge to spend the night playing
                        counter strike! Both these sides need to be catered to. And CODEX club is
                        the organization that does it!!! CODEX club is an all-purpose organization
                        that takes care of all your computing needs. It conducts a host of technical
                        events like workshops and hackathons covering everything you could imagine,
                        from web development to cloud computing.
                    </p>
                    <Link href={"/Events"}>
